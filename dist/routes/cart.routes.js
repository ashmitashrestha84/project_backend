...
router.put("/:product_id", (0, auth_middleware_1.authenticate)(enumtypes_1.User_Only), (0, validator_middleware_1.validate)(cart_validator_1.UpdateCartSchema), cart_controller_1.updateCart);
router.delete("/", cart_controller_1.clearCart);
router.delete("/:product_id", (0, auth_middleware_1.authenticate)(enumtypes_1.User_Only), (0, validator_middleware_1.validate)(cart_validator_1.removeCartSchema), cart_controller_1.removeCart);
